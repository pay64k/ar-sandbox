...
namespace RoomAliveToolkit
{
    ...
    public class RATSceneSetup : MonoBehaviour
    {
        ...
        {
            #if UNITY_EDITOR
            kinectModel = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/RoomAliveToolkit/Models/Kinect.obj");
            projectorModel = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/RoomAliveToolkit/Models/Projector.obj");
            #endif
        }
